...
**M5** ([issue #28](https://github.com/cybrid-systems/daedalus/issues/28)–[#34](https://github.com/cybrid-systems/daedalus/issues/34))  
Optional metered C++ dense-solve for linear `.op` and Newton. Default stays pure.

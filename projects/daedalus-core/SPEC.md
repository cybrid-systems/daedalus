...
- [x] Roadmap M0–M5 recorded (issue #27); native kernel escape landed (#28–#34)
...
- [x] End-to-end pure → C++ hot-swap → dual rollback demo (issue #33, probe 30)
- [x] Optional native backend for linear `.op` and Newton (issue #34, probe 31)
